...
function getCtx(): AudioContext | null {
  try { return getGameAudioBuses('story-trail-immersive').ctx } catch { return null }
}
function getSfxBus(): GainNode { return getGameAudioBuses('story-trail-immersive').sfx }
