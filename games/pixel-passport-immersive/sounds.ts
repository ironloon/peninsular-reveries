...
function getCtx(): AudioContext | null {
  try { return getGameAudioBuses('pixel-passport-immersive').ctx } catch { return null }
}
function getSfxBus(): GainNode { return getGameAudioBuses('pixel-passport-immersive').sfx }
