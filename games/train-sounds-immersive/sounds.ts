...
function getCtx(): AudioContext | null {
  try { return getGameAudioBuses('train-sounds-immersive').ctx } catch { return null }
}
function getSfxBus(): GainNode { return getGameAudioBuses('train-sounds-immersive').sfx }
